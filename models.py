...
class TradingExecutionObservation(Observation):
    ...
    price_momentum: float = Field(default=0.0, description="Price change last 3 steps")
    volatility: float = Field(default=0.0, description="Recent price volatility")
    ...
    fill_rate: float = Field(default=0.0, description="Current fill rate vs target")
